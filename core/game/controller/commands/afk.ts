...
import { roomActivePlayersNumber, recruitByOne, recruit } from "../../model/OperateHelper/Quorum";
import { sendChat } from "../events/onPlayerChat";
import { Command } from "./commandInterface";

export class CmdAfk extends Command {
    public commandId: string = 'afk'
    public timeout: number = 30;
    public helpMan: string = 'Te permite irte AFK o salir de AFK.';

    public execute(byPlayer: PlayerObject, message: string[]): void {
        sendChat(byPlayer, "!afk");
        var placeholder = {
